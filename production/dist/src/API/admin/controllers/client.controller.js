...
class ClientController {
    static getMarkedDeleted(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                res.json(yield client_business_service_1.ClientBusinessService.getMarkedDeleted());
            }
            catch (err) {
                next(err);
            }
            ...
            try {
                ...
                if (typeof ids === "string") {
                    for (const id of ids.split(',')) {
                        yield client_business_service_1.ClientBusinessService.delete(parseInt(id), transaction);
                    }
                }
