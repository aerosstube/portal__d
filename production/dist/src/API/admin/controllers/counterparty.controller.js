...
class CounterpartyController {
            ...
            try {
                ...
                if (typeof ids === 'string') {
                    for (const id of ids.split(',')) {
                        yield counterparty_business_service_1.CounterpartyBusinessService.delete(parseInt(id), transaction);
                    }
    ...
    static getMarkedDeleted(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                res.status(200).json(yield counterparty_business_service_1.CounterpartyBusinessService.getMarkedDeleted());
            }
            catch (err) {
                next(err);
            }
