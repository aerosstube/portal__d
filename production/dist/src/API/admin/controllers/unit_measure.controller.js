...
class UnitMeasureController {
            ...
            try {
                ...
                if (typeof ids === 'string') {
                    for (const id of ids.split(',')) {
                        yield unit_measure_business_service_1.UnitMeasureBusinessService.delete(parseInt(id), transaction);
                    }
    ...
    static getMarkedDeleted(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                res.json(yield unit_measure_business_service_1.UnitMeasureBusinessService.getMarkedDeleted());
            }
            catch (err) {
                next(err);
            }
